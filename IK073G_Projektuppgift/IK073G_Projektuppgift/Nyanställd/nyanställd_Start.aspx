...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
                ...
                <div class="nav">
				        <ul id="navRutor">
					        <li ><a href="nyanställd_Start.aspx" class="current">Nytt Prov</a></li>
                            <li ><a href="nyanställd_MittKonto.aspx">Mitt Prov</a></li>
        ...
        <div class="clearfix">
                    <div class="grid subnavigering mobil hidden" >
				        ...
				        <div id="gridMitten" class="grid gridMiddle mobil" runat="server">
                            <div id="namnet" runat="server" >Välj Person: <asp:DropDownList ID="nyanställningsLista" runat="server" AutoPostBack="True"></asp:DropDownList></div>
                            
                            <p id="provText" runat="server"></p>
                            ...
                            <center><asp:Button ID="görOm" runat="server" Text="Gör om test" OnClientClick="window.open('nyanställd_Start.aspx', 'nyanställd_Start');" Visible="false" /></center>           
