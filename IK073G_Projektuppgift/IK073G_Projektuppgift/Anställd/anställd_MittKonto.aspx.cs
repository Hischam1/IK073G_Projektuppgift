...
{
    public partial class anställd_MittKonto : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                anställningsLista.Items.Insert(0, new ListItem(string.Empty, string.Empty));
        ...
        protected void anställningsLista_SelectedIndexChanged(object sender, EventArgs e)
        {
