...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
                ...
                <div class="nav">
				        <ul id="navRutor">
					        <li ><a href="anställd_Start.aspx">Prov</a></li>
                            <li ><a href="anställd_MittKonto.aspx" class="current">Mitt konto</a></li>
...
<asp:Content ID="Content2" ContentPlaceHolderID="main" runat="server">
     <div class="clearfix">
                    <div class="grid subnavigering mobil" >
                         <ul>
                              <li><div id="namnet" runat="server" style="margin-left: 35%; margin-bottom: 2%;">Välj Person: <asp:DropDownList ID="anställningsLista" runat="server" OnSelectedIndexChanged="anställningsLista_SelectedIndexChanged" AutoPostBack="True"></asp:DropDownList></div></li>
				         </ul>
                    </div>
